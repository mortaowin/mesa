...
func TestSettings(t *testing.T) {
	...
	t.Run("get all settings returns seeded keys", func(t *testing.T) {
		...
		expected := []string{"issue_prefix", "telegram_token", "telegram_chat_id", "github_url", "instance_name", "feature_supermemory", "feature_telegram", "discord_webhook_url", "feature_discord", "feature_run_alignment"}
